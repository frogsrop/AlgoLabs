...
int main ()
{
	...
	{
		my.suff_arr_data[i] = (int)s.size() - my.suff_arr_data[i];
	}
	           
	long long ans = my.suff_arr_data[1];

	for (int i = 2; i < (int)my.suff_arr_data.size(); i++) 
	{
		ans += my.suff_arr_data[i] - my.lcp[i - 1];
	}
